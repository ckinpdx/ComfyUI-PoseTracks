...
class PTCMUMotion:
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                "pose_ref": ("PT_POSE",),
                "pose_sequence_in": ("PT_POSE_SEQUENCE",),
            }
        }
    ...
    def generate(self, library, category, selection_mode, motion_id, transition_frames, loop_mode,
                 target_fps, pose_ref=None, pose_sequence_in=None):
...
# WIDTH CORRECTION:
        ...
        elif pose_ref is not None and transition_frames > 0 and start_frame == 0:
...
# Node mappings
NODE_CLASS_MAPPINGS = {
    "PTCMULibraryLoader": PTCMULibraryLoader,
    "PTCMUMotion": PTCMUMotion,
    "PTCMUSequenceToPTPose": PTCMUSequenceToPTPose,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "PTCMULibraryLoader": "PT CMU Library Loader",
    "PTCMUMotion": "PT CMU Motion",
    "PTCMUSequenceToPTPose": "PT CMU Sequence to Pose",
}
